    ...
    <footer className="text-white bg-secondary body-font">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          ...
          <a className="ml-3" href="https://www.instagram.com/devsoul.it" target="_blank">
            <svg
              fill="none"
              stroke="currentColor"
              stroke-linecap="round"
          ...
          <a className="ml-3" href="https://www.linkedin.com/in/devsoul-it-1478ba314" target="_blank">
            <svg
              fill="currentColor"
              stroke="currentColor"
              stroke-linecap="round"
